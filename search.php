...
?>
<title><?php printbrand("site_title") ?> <?php printtext("results") ?></title>
</head>

<body>
    <form class="sub-search-container" method="get" autocomplete="off">
        <h3 class="logomobile"><a class="no-decoration" href="./"><?php printbrand("site_title"); ?></a></h3>
        <input type="text" name="q" <?php
