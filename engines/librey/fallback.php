...
class LibreYFallback extends EngineRequest
{
    protected $instance;
...
function get_librey_results($opts)
{
    if (!$opts->do_fallback)
        return array();
    ...
    do {
        ...
        $librey_request = new LibreYFallback($instance, $opts, null);

        $results = $librey_request->get_results();
