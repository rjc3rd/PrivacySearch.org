...
<head>
    ...
    <title>405 Method Not Allowed — ProxySearch</title>
...
<body class="bg-white text-zinc-900 dark:bg-zinc-900 dark:text-zinc-100">
    <div class="flex min-h-screen flex-col items-center justify-center gap-4 px-4 pb-24 text-center">
        ...
        <p class="font-mono text-sm text-accent-600 dark:text-accent-400">Error 405</p>
        <h1 class="text-3xl font-bold tracking-tight sm:text-4xl">Method not allowed</h1>
        <p class="max-w-md text-sm text-zinc-500 dark:text-zinc-400">That request method isn't supported for this page.</p>
